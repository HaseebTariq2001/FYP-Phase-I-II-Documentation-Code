...
class _CourseDetailScreenState extends State<CourseDetailScreen> {
      ...
      Navigator.push(
        ...
        if (score.isNotEmpty) {
          ...
          if (parts.length == 2 &&
            ...
            if (unlockedLesson == index) {
              await prefs.setInt('unlockedLesson', index + 1);
              setState(() => unlockedLesson = index + 1);
            }
          }
        }
      });
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      // This intercepts the back button press
      onWillPop: () async {
        // Navigate to the LearningTabScreen instead of popping the current screen
